...
export DATA=/Users/shaoweipng/Google\ Drive/shaoweiworkspace/github.com/mneedham/yelp-graph-algorithms/data

/Users/shaoweipng/Google\ Drive/shaoweiworkspace/neo4j-enterprise-4.1.3/bin/neo4j-admin import \
    --database=yelp2.db \
